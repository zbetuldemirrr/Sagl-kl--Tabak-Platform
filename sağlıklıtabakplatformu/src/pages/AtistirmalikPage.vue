...
export default {
  data() {
    return {
      selectedRecipe: '',
      recipes: [
        { name: 'atistirmalikBir', displayName: 'Atıştırmalık Bir', image: 'kinoa.png', link: '/atistirmalikbir', favorite: false },
        { name: 'atistirmalikIki', displayName: 'Atıştırmalık İki', image: 'mercimek.png', link: '/atistirmalikiki', favorite: false },
        { name: 'atistirmalikUc', displayName: 'Atıştırmalık Üç', image: 'brokoli.png', link: '/atistirmalikuc', favorite: false },
      ],
    };
  },
  mounted() {
