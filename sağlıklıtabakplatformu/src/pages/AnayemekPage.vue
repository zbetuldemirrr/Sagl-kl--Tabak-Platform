...
export default {
  data() {
    return {
      selectedRecipe: '',
      recipes: [
        { name: 'anayemekBir', displayName: 'Anayemek Bir', image: 'brokoli.png', link: '/anayemekbir' },
        { name: 'anayemekIki', displayName: 'Anayemek İki', image: 'mercimek.png', link: '/anayemekiki' },
        { name: 'anayemekUc', displayName: 'Anayemek Üç', image: 'kinoa.png', link: '/anayemekuc' },
      ],
    };
  },
   mounted() {
