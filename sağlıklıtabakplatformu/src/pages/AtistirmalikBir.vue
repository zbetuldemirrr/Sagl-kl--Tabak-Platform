<template>
  <div class="nohut-container">
    <div class="card-container">
      <div class="nohut-card">
        <h1 class="nohut-title">Fırınlanmış Nohut Cipsi</h1>
        <img src="@/assets/nohut2.png" alt="Nohut Cipsi" class="card-image">
      </div>
      <div class="nohut-card">
        <h2 class="nohut-title">Malzemeler</h2>
      ...
      <div class="nohut-card">
        <h2 class="nohut-title">Yapılışı</h2>
        <ul class="instruction-list">
          <li>• Fırını 200 dereceye ısıtın.</li>
          <li>• Haşlanmış nohutları iyice kurulayın.</li>
          <li>• Zeytinyağı ve baharatları bir kapta karıştırın.</li>
          <li>• Nohutları bu karışıma ekleyip iyice karıştırın.</li>
          <li>• Yağlı kağıt serili fırın tepsisine yayın.</li>
          <li>• 20-25 dakika boyunca fırında çıtır hale gelene kadar pişirin.</li>
        </ul>
      </div>
...
export default {
  ...
  computed: {
    filteredReviews() {
      return this.reviews.filter(review => review.tarif === 'Fırınlanmış Nohut Cipsi');
    },
    averageRating() {
      const nohutReviews = this.filteredReviews;
      if (nohutReviews.length === 0) return 0;
      const totalRating = nohutReviews.reduce((acc, review) => acc + review.rating, 0);
      return totalRating / nohutReviews.length;
    },
  },
  methods: {
    setRating(star) {
