<template>
  <div class="pirasa-container">
    <div class="card-container">
      <div class="pirasa-card">
        <h1 class="pirasa-title">Pirinçli Pırasa Yemeği</h1>
        <img src="@/assets/pirasa2.png" alt="Pirinçli Pırasa Yemeği" class="card-image">
      </div>
      <div class="pirasa-card">
        <h2 class="pirasa-title">Malzemeler</h2>
      ...
      <div class="pirasa-card">
        <h2 class="pirasa-title">Yapılışı</h2>
        <ul class="instruction-list">
          <li>• Pırasaları temizleyip ince dilimler halinde kesin.</li>
          <li>• Soğanı yemeklik doğrayın.</li>
          <li>• Zeytinyağını geniş bir tencereye alıp soğanları kavurun.</li>
          <li>• Pırasaları ekleyip bir süre daha kavurun.</li>
          <li>• Yıkanmış pirinci tencereye ekleyin.</li>
          <li>• Sıcak suyu ilave edin, tuz ve karabiber ekleyin.</li>
          <li>• Pirinçler yumuşayana kadar pişirin.</li>
          <li>• Ocaktan almadan önce limon suyunu ekleyin, karıştırın.</li>
          <li>• Sıcak servis yapın.</li>
        </ul>
      </div>
    ...
    <div class="reviews" v-if="showReviews">
      <div v-for="review in filteredReviews.slice(0, reviewsToShow)" :key="review.id" class="review">
...
export default {
  ...
  computed: {
    filteredReviews() {
      return this.reviews.filter(review => review.tarif === 'Pirinçli Pırasa Yemeği');
    },
    averageRating() {
      const pirasaReviews = this.filteredReviews;
      if (pirasaReviews.length === 0) return 0;
      const totalRating = pirasaReviews.reduce((acc, review) => acc + review.rating, 0);
      return totalRating / pirasaReviews.length;
    },
  },
  methods: {
    setRating(star) {
