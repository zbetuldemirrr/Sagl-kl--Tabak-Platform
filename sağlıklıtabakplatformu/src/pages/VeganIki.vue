<template>
  <div class="vegan-container">
    <div class="vegan-card">
      <h1 class="vegan-title">Vegan Pancake</h1>
      <img src="@/assets/pancake2.png" alt="Vegan Pancake" class="card-image">
    </div>
    <div class="vegan-card">
      ...
      <ul class="ingredient-list">
        ...
        <li>• 2 tatlı kaşığı kabartma tozu</li>
        <li>• 1/8 tatlı kaşığı tuz</li>
        <li>• 3/4 su bardağı badem sütü (veya herhangi bir bitkisel süt)</li>
        <li>• 1 yemek kaşığı bitkisel yağ</li>
        <li>• 1 tatlı kaşığı vanilya özü</li>
        <li>• Üzeri için akçaağaç şurubu ve taze meyveler</li>
      </ul>
    </div>
    <div class="vegan-card">
      <h2 class="vegan-title">Yapılışı</h2>
      <ul class="instruction-list">
        <li>• Un, şeker, kabartma tozu ve tuzu bir kapta karıştırın.</li>
        <li>• Başka bir kapta badem sütü, bitkisel yağ ve vanilya özünü karıştırın.</li>
        <li>• Islattığınız karışımları birleştirin ve karışana kadar karıştırın.</li>
        <li>• Yumuşak bir kıvam elde edinceye kadar karıştırmaya devam edin.</li>
        <li>• Yüksek ateşte ısıtılmış bir tavada hafifçe yağlayın.</li>
        <li>• Her pancake için 1/4 su bardağı karışım dökün.</li>
        <li>• Üstte kabarcıklar oluşana kadar pişirin, sonra çevirin ve altın rengini alana kadar pişirin.</li>
        <li>• Akçaağaç şurubu ve taze meyvelerle servis yapın.</li>
      </ul>
    </div>
...
export default {
  ...
  computed: {
    filteredReviews() {
      return this.reviews.filter(review => review.tarif === 'Vegan Köfte');
    },
    averageRating() {
