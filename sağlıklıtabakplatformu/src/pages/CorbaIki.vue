  ...
  <div class="corba-container">
    <div class="card-container">
      <div class="corba-card">
        <h1 class="corba-title">Bamya Çorbası</h1>
        <img src="@/assets/bamya2.png" alt="Bamya Çorbası" class="card-image">
      </div>
      <div class="corba-card">
        <h2 class="corba-title">Malzemeler</h2>
        <ul class="ingredient-list">
          <li>• 250 gr taze bamya</li>
          <li>• 1 adet kuru soğan</li>
          <li>• 1 adet domates</li>
          <li>• 1 yemek kaşığı tereyağı veya zeytinyağı</li>
          <li>• 1 yemek kaşığı un</li>
          <li>• 5 su bardağı et suyu veya su</li>
          <li>• Tuz, karabiber</li>
          <li>• Limon (isteğe bağlı)</li>
        </ul>
      </div>
      <div class="corba-card">
        <h2 class="corba-title">Yapılışı</h2>
        <ul class="instruction-list">
          <li>• Bamyaları yıkayıp ikiye bölün.</li>
          <li>• Soğanı küçük küpler halinde doğrayın.</li>
          <li>• Domatesi rendeleyin veya küçük küpler halinde doğrayın.</li>
          <li>• Tereyağını veya zeytinyağını tencerede eritin.</li>
          <li>• Soğanı ekleyip pembeleşene kadar kavurun.</li>
          <li>• Unu ekleyip kokusu çıkana kadar kavurun.</li>
          <li>• Domatesi ekleyip birkaç dakika daha kavurun.</li>
          <li>• Bamyaları ekleyip karıştırın.</li>
          <li>• Et suyunu veya suyu ekleyip bamyalar yumuşayana kadar pişirin.</li>
          <li>• Tuz ve karabiber ekleyip karıştırın.</li>
          <li>• İsteğe bağlı olarak limon suyu ekleyip karıştırın.</li>
...
export default {
  ...
  computed: {
    filteredReviews() {
      return this.reviews.filter(review => review.tarif === 'Bamya Çorbası');
    },
    averageRating() {
