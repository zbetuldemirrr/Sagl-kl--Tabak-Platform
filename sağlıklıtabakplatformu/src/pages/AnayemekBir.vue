<template>
  <div class="somon-container">
    <div class="card-container">
      <div class="somon-card">
        <h1 class="somon-title">Tavada Sebzeli Somon</h1>
        <img src="@/assets/somon2.png" alt="Tavada Sebzeli Somon" class="card-image">
      </div>
      <div class="somon-card">
        <h2 class="somon-title">Malzemeler</h2>
        <ul class="ingredient-list">
          <li>• 4 adet somon fileto</li>
      ...
      <div class="somon-card">
        <h2 class="somon-title">Yapılışı</h2>
        <ul class="instruction-list">
          <li>• Somon filetolarını tuz, karabiber ve kekikle marine edin.</li>
          <li>• Zeytinyağını tavaya alıp somonları kızartın.</li>
          <li>• Kızaran somonları tavadan alıp bir kenara koyun.</li>
          <li>• Aynı tavada doğranmış soğan ve sarımsakları kavurun.</li>
          <li>• Doğranmış biberleri ekleyip kavurmaya devam edin.</li>
          <li>• Limon dilimlerini ekleyip bir süre daha pişirin.</li>
          <li>• Somonları tekrar tavaya alıp sebzelerle birlikte ısıtın.</li>
...
export default {
  ...
  computed: {
    filteredReviews() {
      return this.reviews.filter(review => review.tarif === 'Tavada Sebzeli Somon');
    },
    averageRating() {
      const somonReviews = this.filteredReviews;
      if (somonReviews.length === 0) return 0;
      const totalRating = somonReviews.reduce((acc, review) => acc + review.rating, 0);
      return totalRating / somonReviews.length;
    },
  },
  methods: {
    setRating(star) {
