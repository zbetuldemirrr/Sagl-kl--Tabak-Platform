  ...
  <div class="vegan-container">
    <div class="card-container">
      <div class="vegan-card">
        <h1 class="vegan-title">Vegan Köfte</h1>
        <img src="@/assets/kofte2.png" alt="Vegan Köfte" class="card-image">
      </div>
      <div class="vegan-card">
      ...
      <div class="vegan-card">
        ...
        <ul class="instruction-list">
          <li>• Kırmızı mercimeği haşlayın ve süzün.</li>
          <li>• Soğanı ve havucu küçük küpler halinde doğrayın.</li>
          <li>• Bulguru sıcak suyla ıslatın ve süzün.</li>
          <li>• Maydanoz ve dereotunu ince doğrayın.</li>
          <li>• Haşlanmış mercimeği, doğranmış soğanı, havucu, bulguru, salçayı ve baharatları bir kasede yoğurun.</li>
          <li>• Harcı yoğurduktan sonra köfte şekli verin.</li>
          <li>• Izgara veya tavada köfteleri pişirin.</li>
          <li>• Pişen köfteleri servis yapmadan önce dinlendirin.</li>
        </ul>
      </div>
