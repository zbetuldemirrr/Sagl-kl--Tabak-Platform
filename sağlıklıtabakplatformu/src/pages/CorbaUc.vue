  ...
  <div class="corba-container">
    <div class="card-container">
      <div class="corba-card">
        <h1 class="corba-title">Enginar Çorbası</h1>
        <img src="@/assets/enginarcorba2.png" alt="Enginar Çorbası" class="card-image">
      </div>
      <div class="corba-card">
        <h2 class="corba-title">Malzemeler</h2>
        <ul class="ingredient-list">
          <li>• 2 adet enginar</li>
          <li>• 1 adet patates</li>
          <li>• 1 adet soğan</li>
          <li>• 1 yemek kaşığı tereyağı veya zeytinyağı</li>
          <li>• 1 yemek kaşığı un</li>
          <li>• 5 su bardağı sebze suyu veya su</li>
          <li>• Tuz, karabiber</li>
          <li>• Limon suyu</li>
        </ul>
      </div>
      <div class="corba-card">
        ...
        <ul class="instruction-list">
          <li>• Enginarları temizleyip doğrayın ve limonlu suda bekletin.</li>
          <li>• Soğanı ve patatesi küçük küpler halinde doğrayın.</li>
          <li>• Tencereye tereyağını veya zeytinyağını ekleyip eritin.</li>
          <li>• Soğanı ekleyip yumuşayana kadar kavurun.</li>
          <li>• Patatesi ve enginarı ekleyip birkaç dakika daha kavurun.</li>
          <li>• Unu ekleyip kokusu çıkana kadar kavurun.</li>
          <li>• Sebze suyunu veya suyu ekleyip malzemeler yumuşayana kadar pişirin.</li>
...
export default {
  ...
  computed: {
    filteredReviews() {
      return this.reviews.filter(review => review.tarif === 'Enginar Çorbası');
    },
    averageRating() {
