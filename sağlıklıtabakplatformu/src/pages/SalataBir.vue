  ...
  <div class="salata-container">
    <div class="card-container">
      <div class="salata-card">
        <h1 class="salata-title">Brokoli Salatası</h1>
        <img src="@/assets/brokoli2.png" alt="Narlı Brokoli Salatası" class="card-image">
      </div>
      <div class="salata-card">
        <h2 class="salata-title">Malzemeler</h2>
        <ul class="ingredient-list">
          <li>• 1 demet brokoli</li>
          <li>• 1 su bardağı nar taneleri</li>
          <li>• 1 çay bardağı ceviz içi</li>
          <li>• Yarım demet taze soğan</li>
      ...
      <div class="salata-card">
        ...
        <ul class="instruction-list">
          <li>• Brokolileri ayıklayıp yıkayın ve küçük çiçeklere ayırın.</li>
          <li>• Bir tencerede hafifçe tuzlu suda brokolileri haşlayın, süzün ve soğumaya bırakın.</li>
          <li>• Soğanları ince ince doğrayın, maydanozu ve ceviz içlerini irice doğrayın.</li>
          <li>• Haşlanmış brokolileri, nar tanelerini, taze soğanı, maydanozu ve ceviz içlerini büyük bir salata kasesine alın.</li>
          <li>• Üzerine zeytinyağı, limon suyu, tuz ve karabiber ekleyin.</li>
...
export default {
  ...
  computed: {
    filteredReviews() {
      return this.reviews.filter(review => review.salata === 'Brokoli Salatası');
    },
    averageRating() {
      const brokoliSalatasiReviews = this.filteredReviews;
      if (brokoliSalatasiReviews.length === 0) return 0;
      const totalRating = brokoliSalatasiReviews.reduce((acc, review) => acc + review.rating, 0);
      return totalRating / brokoliSalatasiReviews.length;
    },
  },
  methods: {
    setRating(star) {
